...
{
    public class TicketUnnecessaryWriteRepository : WriteRepository<TicketUnnecessary>, ITicketUnnecessaryWriteRepository
    {
        public TicketUnnecessaryWriteRepository(DestekDbContext context) : base(context)
        {
        }
    }
}
