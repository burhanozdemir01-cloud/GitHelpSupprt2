...
namespace Destek.Infrastructure.Services.Configurations
{
                    ...
                    if (actions != null)
                        foreach (var action in actions)
                        {
                            ...
                            if (attributes != null)
                            {
                                ...
                                _action.Code = $"{controller.Name}.{_action.HttpType}.{_action.ActionType}.{_action.Definition.Replace(" ", "")}";

                                menu.ActionDto.Add(_action);
                            }
                        }
                }
